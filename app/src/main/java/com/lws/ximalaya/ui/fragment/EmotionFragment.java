 ...
 */
public class EmotionFragment  extends BaseMVPFragment<DiscoveryPresenter> implements DiscoverContract.View{
    ...
    public  static EmotionFragment getInstance(){

        EmotionFragment wodeFragment = new EmotionFragment();
        return  wodeFragment;
    }
    @Override
