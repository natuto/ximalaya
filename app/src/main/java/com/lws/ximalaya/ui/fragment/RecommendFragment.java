 ...
 */
public class RecommendFragment extends BaseMVPFragment<DiscoveryPresenter>implements DiscoverContract.View{
    ...
    public  static RecommendFragment getInstance(){
        ...
        RecommendFragment wodeFragment = new RecommendFragment();
        return  wodeFragment;
    }
