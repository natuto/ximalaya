 ...
 */
public class CrossTalkFragment extends BaseMVPFragment<DiscoveryPresenter> implements DiscoverContract.View{
    @BindView(R.id.recycler_view)
    RecyclerView mRecyclerView;
    private LinearLayoutManager mLinearLayoutManager;
    private RecommendAdaper mRecyclerAdaper;
    public  static CrossTalkFragment getInstance(){

        CrossTalkFragment wodeFragment = new CrossTalkFragment();
        return  wodeFragment;
    }
    @Override
